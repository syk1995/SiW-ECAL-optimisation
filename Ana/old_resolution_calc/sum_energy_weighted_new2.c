...
void sum_energy_weighted_notcorr2(char* filename, float input_energy, double_t &mean, double_t &error_val){

    //write the fit parameters to a txt file
    //for the e- files from fabricio
    ofstream myfile;
    myfile.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_mean2.txt", std::ios_base::app);
    ...
    if (input_energy < 1) {
        ...
        error_val = std_hisnt / TMath::Sqrt(entries);
...
TSpline3 *spline_fit_we2;

double_t spline_hits_we2(double energy_sum){
    double_t val = spline_fit_we2->Eval(energy_sum);
    return val;
}

void sum_energy_weighted_notcorr2(char* filename, int input_energy, double_t &mean, double_t &error_val);
...
void sum_energy_weighted_corr2(char* filename, float input_energy, ofstream &mean_file, ofstream &gauss_file, ofstream &gauss_file2s, ofstream &rms_file, ofstream &myfile_3sig, ofstream &myfile_3sig_fit){
    ...
    if (input_energy < 1) {
        ...
        tree->Draw("spline_hits_we2(Sum$(hit_energy*f2(hit_slab)))");
...
void sum_energy_weighted_new2(){
    ...
    myfile_events.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_mean2.txt");
    ...
    for (int i = 0; i < 3; i++) {
        ...
        sum_energy_weighted_notcorr2((char*)argument.c_str(), energies[i], mean_val, error_val);
    ...
    spline_fit_we2 = new TSpline3("spline_interpol", mean_values, energies_plot, 16);
    ...
    ofstream mean_file;
    mean_file.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_corr_mean2.txt");
    mean_file << "energy,mean,sigma" << "\n";

    ofstream gauss_file;
    gauss_file.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_corr_gauss2.txt");
    gauss_file << "energy,mean,mean_err,sigma,sigma_err,goodness" << "\n";

    ofstream gauss_file2s;
    gauss_file2s.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_corr_gauss2s2.txt");
    gauss_file2s << "energy,mean,mean_err,sigma,sigma_err,goodness" << "\n";

    ofstream rms_file;
    rms_file.open ("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted_corr_rms902.txt");
    rms_file << "energy,mean,sigma" << "\n";

    ofstream myfile_3sig;
    myfile_3sig.open("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_ratio_3sigmas_sum_energy_weighted2.txt");
    myfile_3sig << "energy,ratio" << "\n";

    ofstream myfile_3sig_fit;
    myfile_3sig_fit.open("/home/llr/ilc/ritzmann/work/res_csv_files/conf6_e-_GeV_5kevt_-42_-42_build_masked_ratio_3sigmas_sum_energy_weighted2_fitted.txt");
    ...
    for (int i = 0; i < 3; i++) {
        ...
        sum_energy_weighted_corr2((char*)argument.c_str(), energies[i], mean_file, gauss_file, gauss_file2s, rms_file, myfile_3sig, myfile_3sig_fit);
    }
