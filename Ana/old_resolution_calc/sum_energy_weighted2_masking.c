...
void sum_energy_weighted2_masking(char* filename, int input_energy){

    ofstream myfile;
    myfile.open ("/home/llr/ilc/ritzmann/work/ECAL_QGSP_BERT_conf6_e-_GeV_5kevt_-42_-42_build_masked_params_sum_energy_weighted2_masking.txt", std::ios_base::app);
    ...
    tree -> Draw("Sum$((hit_isMasked==0)*hit_energy*f2(hit_slab))");
